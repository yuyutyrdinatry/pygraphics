# -*- coding: utf-8 -*-
#
# PyGraphics documentation build configuration file, created by
...
htmlhelp_basename = 'PyGraphicsdoc'
...
latex_documents = [
  ('index', 'PyGraphics.tex', u'PyGraphics Documentation',
...
man_pages = [
    ('index', 'pygraphics', u'PyGraphics Documentation',
     [u'A lot of people'], 1)
]
