SETUPTOOLS
-----------
For some of the available manuals, tutorials, and other resources for learning about Setuptools, Python Eggs, and EasyInstall check:
...
NOSE: Finding and running tests
-------------------------
