...
def pixel_has_color(pixel, color):
    ...
    return (pixel.get_red() == color.red and
            pixel.get_green() == color.green and
            pixel.get_blue() == color.blue)
...
def test_set_get_color():
    ...
    for col in colors:
        ...
        assert pixel_has_color(tester_pixel, col), \
            'Colors do not match (%s, %s)' % (tester_pixel, col)
        assert tester_pixel.get_color() == col, \
            'Colors do not match (%s, %s)' % (tester_pixel.get_color(), col)
